...
public interface Solution {
    ...
    /**
     * <p>We have {code n} buildings numbered from {code 0} to {code n - 1}. Each building has a number of employees.
     * It's transfer season, and some employees want to change the building they reside in.</p>
     *
     * <p>You are given an array {code requests} where {code requests[i] = [from}<sub>i</sub>{code , to}<sub>i</sub>]
     ...
     * one is leaving building {code 2}, there should be two employees moving to building {code 0}, one employee moving
     * to building {code 1}, and one employee moving to building {code 2}.</p>
     *
     *
     * <p>&nbsp;</p>
