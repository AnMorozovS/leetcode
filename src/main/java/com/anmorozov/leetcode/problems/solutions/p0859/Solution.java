...
public interface Solution {
     ...
     *
     * <ul>
     * 	<li>For example, swapping at indices {@code 0} and {@code 2} in {@code "abcd"} results in {@code "cbad"}.</li>
     *
     * 	<p>&nbsp;</p>
     ...
     * @return return {@code true}<em> if you can swap two letters in </em>{@code s}<em> so the result is equal to
     * </em>{@code goal}<em>, otherwise, return </em>{@code false}<em>
     */
